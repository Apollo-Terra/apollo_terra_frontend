...
const Home = () => {
  // Coordenadas aproximadas do centro do Ceará
  const cearaPosition = [-5.20, -39.50];

  // Estado para armazenar a data selecionada e a URL da camada de satélite
   ...
   return (
    <div className="home-container">
      <header className="home-header">
        <h2>Apollo Terra: Inovação no Combate à Fome no Ceará</h2>
        <p>Selecione uma data e obseve a timeline de uma região.</p>
      </header>
